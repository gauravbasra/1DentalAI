...
const requiredFiles = [
  ...
  "src/app/api/twilio/sms/incoming/route.ts",
...
const requiredApiEndpoints = [
  ...
  ["POST /api/twilio/voice/incoming", "src/app/api/twilio/voice/incoming/route.ts"],
  ["POST /api/twilio/voice/status", "src/app/api/twilio/voice/status/route.ts"],
  ["POST /api/twilio/voice/recording", "src/app/api/twilio/voice/recording/route.ts"],
  ["POST /api/twilio/voice/transcription", "src/app/api/twilio/voice/transcription/route.ts"],
  ["POST /api/twilio/sms/incoming", "src/app/api/twilio/sms/incoming/route.ts"],
...
const haystack = [
  ...
  read("src/lib/twilio-webhooks.ts"),
  read("src/app/api/twilio/voice/incoming/route.ts"),
  read("src/app/api/twilio/sms/incoming/route.ts"),
